...
do
  ...
  if [ ! -e "$s"/surf_meld/FLAIR.rh.w-g.pct.mgh ];  then
  ...
  bbregister --s "$s" --mov "$s" --mov "$s"/flair_registered.mgz --reg "$s"/mri/transforms/Identity.dat --init-fsl --t1
  ...
  do
    ...
    D="0.5 0.25 0.75 0"
      ...
      do
        ...
        mri_vol2surf --src "$s"/flair_registered.mgz --out "$s"/surf_meld/"$h".gm_FLAIR_"$d".mgh --hemi "$h" --projfrac "$d" --srcreg "$s"/mri/transforms/Identity.dat --trgsubject "$s" --surf white
        #smoothing
    ...
    for d_wm in $D_wm
    do
      mri_vol2surf --src "$s"/flair_registered.mgz --out "$s"/surf_meld/"$h".wm_FLAIR_"$d_wm".mgh --hemi "$h" --projdist -"$d_wm" --srcreg "$s"/mri/transforms/Identity.dat --trgsubject "$s" --surf white
      #mris_fwhm --s "$s" --hemi "$h" --cortex --smooth-only --fwhm 10\
    ...
    mris_fwhm --s "$s" --hemi "$h" --cortex --smooth-only --fwhm 10\
     --i "$s"/surf/"$h".thickness --o "$s"/surf_meld/FLAIR."$h".thickness.sm10.mgh
    mris_fwhm --s "$s" --hemi "$h" --cortex --smooth-only --fwhm 10\
    --i "$s"/surf/"$h".w-g.pct.mgh --o "$s"/surf_meld/FLAIR."$h".w-g.pct.sm10.mgh
    ...
    mris_convert -c "$s"/surf/"$h".curv "$s"/surf/"$h".white "$s"/surf_meld/FLAIR."$h".curv.mgh
    mris_convert -c "$s"/surf/"$h".sulc "$s"/surf/"$h".white "$s"/surf_meld/FLAIR."$h".sulc.mgh
    mris_convert -c "$s"/surf/"$h".pial.K.crv "$s"/surf/"$h".white "$s"/surf_meld/FLAIR."$h".pial.K.mgh
    mris_calc --output "$s"/surf_meld/FLAIR."$h".pial.K_filtered.mgh "$s"/surf_meld/FLAIR."$h".pial.K.mgh abs
    mris_fwhm --s "$s" --hemi "$h" --cortex --smooth-only --fwhm 20\
    --i "$s"/surf_meld/FLAIR."$h".pial.K_filtered.mgh --o "$s"/surf_meld/FLAIR."$h".pial.K_filtered.sm20.mgh

    mris_convert -c "$s"/surf/"$h".thickness "$s"/surf/"$h".white "$s"/surf_meld/FLAIR."$h".thickness.mgh
    cp "$s"/surf/"$h".w-g.pct.mgh "$s"/surf_meld/FLAIR."$h".w-g.pct.mgh
